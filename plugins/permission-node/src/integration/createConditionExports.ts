 ...
 * corresponding {@link PermissionCondition}.
 * @public
 */
 ...
 * {@link PermissionCondition} factory for each of the supplied {@link PermissionRule}s, along
 * with a `createConditions` function which builds the wrapper object needed to enclose
 * conditions when authoring {@link PermissionPolicy} implementations.
 *
