...
/**
 * A function which accepts {@link PermissionCondition}s logically grouped
 * in a {@link PermissionCriteria} object, and transforms the
 * {@link PermissionCondition}s into plugin specific query fragments while
 * retaining the enclosing criteria shape.
 *
 * @public
 */
